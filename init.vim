...
highlight Search gui=NONE guibg=#292D3E
...
"                                                           "
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
command! -nargs=0 Idfind call TranslationLookup()
...
let $FZF_DEFAULT_OPTS = '--color=bg:#0F111A,bg+:#0F111A --layout=reverse'
...
function! ToggleRanger()
    let file = expand('%')
    call CreateCenteredFloatingWindow()
    call termopen('ranger --choosefile=/tmp/chosenfile --selectfile=' . file, { 'on_exit': function('OnRangerExit') })
endfunction
...
augroup autocommands
    ...
    au FileType java nnoremap <F8> :AsyncRun ufant<CR>
    au FileType java nnoremap <F9> :AsyncRun ufstop && ufstart<CR>
