return {
  ...
  config = function()
    ...
    vim.keymap.set('v', '<leader>ca', function() require('fzf-lua').lsp_code_actions() end, {desc = "LSP: Code action"})
    vim.keymap.set('n', '<leader>ca', function() require('fzf-lua').lsp_code_actions() end, {desc = "LSP: Code action"})
  end,
  keys = {
